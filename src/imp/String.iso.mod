...
BEGIN
  ...
  CASE size OF
  |             1 : string^.intern := CAST(AOC.Len1, addr)
  |             2 : string^.intern := CAST(AOC.Len2, addr)
  |             3 : string^.intern := CAST(AOC.Len3, addr)
  |             4 : string^.intern := CAST(AOC.Len4, addr)
  |             5 : string^.intern := CAST(AOC.Len5, addr)
  |             6 : string^.intern := CAST(AOC.Len6, addr)
  |             7 : string^.intern := CAST(AOC.Len7, addr)
  |             8 : string^.intern := CAST(AOC.Len8, addr)
  |             9 : string^.intern := CAST(AOC.Len9, addr)
  |            10 : string^.intern := CAST(AOC.Len10, addr)
  |            11 : string^.intern := CAST(AOC.Len11, addr)
  |            12 : string^.intern := CAST(AOC.Len12, addr)
  |            13 : string^.intern := CAST(AOC.Len13, addr)
  |            14 : string^.intern := CAST(AOC.Len14, addr)
  |            15 : string^.intern := CAST(AOC.Len14, addr)
  |            16 : string^.intern := CAST(AOC.Len16, addr)
  |            17 : string^.intern := CAST(AOC.Len17, addr)
  |            18 : string^.intern := CAST(AOC.Len18, addr)
  |            19 : string^.intern := CAST(AOC.Len19, addr)
  |            20 : string^.intern := CAST(AOC.Len20, addr)
  |            21 : string^.intern := CAST(AOC.Len21, addr)
  |            22 : string^.intern := CAST(AOC.Len22, addr)
  |            23 : string^.intern := CAST(AOC.Len23, addr)
  |            24 : string^.intern := CAST(AOC.Len24, addr)
  |            25 : string^.intern := CAST(AOC.Len25, addr)
  |            26 : string^.intern := CAST(AOC.Len26, addr)
  |            27 : string^.intern := CAST(AOC.Len27, addr)
  |            28 : string^.intern := CAST(AOC.Len28, addr)
  |            29 : string^.intern := CAST(AOC.Len29, addr)
  |            20 : string^.intern := CAST(AOC.Len30, addr)
  |            31 : string^.intern := CAST(AOC.Len31, addr)
  |            32 : string^.intern := CAST(AOC.Len32, addr)
  |            33 : string^.intern := CAST(AOC.Len33, addr)
  |            34 : string^.intern := CAST(AOC.Len34, addr)
  |            35 : string^.intern := CAST(AOC.Len35, addr)
  |            36 : string^.intern := CAST(AOC.Len36, addr)
  |            37 : string^.intern := CAST(AOC.Len37, addr)
  |            38 : string^.intern := CAST(AOC.Len38, addr)
  |            39 : string^.intern := CAST(AOC.Len39, addr)
  |            40 : string^.intern := CAST(AOC.Len40, addr)
  |            41 : string^.intern := CAST(AOC.Len41, addr)
  |            42 : string^.intern := CAST(AOC.Len42, addr)
  |            43 : string^.intern := CAST(AOC.Len43, addr)
  |            44 : string^.intern := CAST(AOC.Len44, addr)
  |            45 : string^.intern := CAST(AOC.Len45, addr)
  |            46 : string^.intern := CAST(AOC.Len46, addr)
  |            47 : string^.intern := CAST(AOC.Len47, addr)
  |            48 : string^.intern := CAST(AOC.Len48, addr)
  |            49 : string^.intern := CAST(AOC.Len49, addr)
  |            50 : string^.intern := CAST(AOC.Len50, addr)
  |            51 : string^.intern := CAST(AOC.Len51, addr)
  |            52 : string^.intern := CAST(AOC.Len52, addr)
  |            53 : string^.intern := CAST(AOC.Len53, addr)
  |            54 : string^.intern := CAST(AOC.Len54, addr)
  |            55 : string^.intern := CAST(AOC.Len55, addr)
  |            56 : string^.intern := CAST(AOC.Len56, addr)
  |            57 : string^.intern := CAST(AOC.Len57, addr)
  |            58 : string^.intern := CAST(AOC.Len58, addr)
  |            59 : string^.intern := CAST(AOC.Len59, addr)
  |            60 : string^.intern := CAST(AOC.Len60, addr)
  |            61 : string^.intern := CAST(AOC.Len61, addr)
  |            62 : string^.intern := CAST(AOC.Len62, addr)
  |            63 : string^.intern := CAST(AOC.Len63, addr)
  |            64 : string^.intern := CAST(AOC.Len64, addr)
  |            65 : string^.intern := CAST(AOC.Len65, addr)
  |            66 : string^.intern := CAST(AOC.Len66, addr)
  |            67 : string^.intern := CAST(AOC.Len67, addr)
  |            68 : string^.intern := CAST(AOC.Len68, addr)
  |            69 : string^.intern := CAST(AOC.Len69, addr)
  |            70 : string^.intern := CAST(AOC.Len70, addr)
  |            71 : string^.intern := CAST(AOC.Len71, addr)
  |            72 : string^.intern := CAST(AOC.Len72, addr)
  |            73 : string^.intern := CAST(AOC.Len73, addr)
  |            74 : string^.intern := CAST(AOC.Len74, addr)
  |            75 : string^.intern := CAST(AOC.Len75, addr)
  |            76 : string^.intern := CAST(AOC.Len76, addr)
  |            77 : string^.intern := CAST(AOC.Len77, addr)
  |            78 : string^.intern := CAST(AOC.Len78, addr)
  |            79 : string^.intern := CAST(AOC.Len79, addr)
  |            80 : string^.intern := CAST(AOC.Len80, addr)
  |    81 ..   96 : string^.intern := CAST(AOC.Len96, addr)
  |    97 ..  112 : string^.intern := CAST(AOC.Len112, addr)
  |   113 ..  128 : string^.intern := CAST(AOC.Len128, addr)
  |   129 ..  256 : string^.intern := CAST(AOC.Len256, addr)
  |   257 ..  384 : string^.intern := CAST(AOC.Len384, addr)
  |   385 ..  512 : string^.intern := CAST(AOC.Len512, addr)
  |   513 ..  768 : string^.intern := CAST(AOC.Len768, addr)
  |   769 .. 1024 : string^.intern := CAST(AOC.Len1024, addr)
  |  1025 .. 1280 : string^.intern := CAST(AOC.Len1280, addr)
  |  1281 .. 1792 : string^.intern := CAST(AOC.Len1792, addr)
  |  1793 .. 2048 : string^.intern := CAST(AOC.Len2048, addr)
  |  2049 .. 2304 : string^.intern := CAST(AOC.Len2304, addr)
  |  2305 .. 2560 : string^.intern := CAST(AOC.Len2560, addr)
  |  2561 .. 2816 : string^.intern := CAST(AOC.Len2816, addr)
  |  2817 .. 3072 : string^.intern := CAST(AOC.Len3072, addr)
  |  3073 .. 3328 : string^.intern := CAST(AOC.Len3328, addr)
  |  3329 .. 3584 : string^.intern := CAST(AOC.Len3584, addr)
  |  3585 .. 3840 : string^.intern := CAST(AOC.Len3840, addr)
  |  3841 .. 4096 : string^.intern := CAST(AOC.Len4096, addr)
  END (* CASE *)
END NewStrWithArray;
